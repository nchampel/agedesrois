...
if ((int)$castleLevel <= (int)$_SESSION['player']->$getter()) {
...
// } else {
HandleResources::substractConstructStock($foodNeeded, $woodNeeded, $metalNeeded, $stoneNeeded, $goldNeeded, $id);
// }
...
$rqt = "UPDATE level_constructs_stock set " . $typeColumn . "= :level where id_player = :id";
