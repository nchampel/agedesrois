...
<p><?php echo ucfirst($_SESSION['barracks']['name']); ?> niveau <span id="barracks-level"><?php echo $_SESSION['barracks-level']; ?></span> </p>

<p><?php echo ucfirst($_SESSION['workshop']['name']); ?> niveau <span id="workshop-level"><?php echo $_SESSION['workshop-level']; ?></span> </p>